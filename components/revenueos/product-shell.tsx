...
export function ProductNav() {
  const navigation = [["Website Guard", "/revenueos/website-guard"], ["Catalog Guard", "/revenueos/catalog-guard"], ["Migration Guard", "/revenueos/migration-guard"], ["Platforms", "/revenueos/platforms"], ["Validation", "/revenueos/validation"], ["Audit", "/revenueos/audit"]] as const;
